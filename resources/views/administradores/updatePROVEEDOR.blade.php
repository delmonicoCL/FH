    ...
    <form action="{{action([App\Http\Controllers\UsuarioController::class,'update'],['usuario'=> $usuario->id,'tipo'=> $usuario->tipo])}}" id="formularioinscripcion" method="POST">
        ...
        @method('PUT')
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" class="form-control" id="numero" name="numero" value="{{ $proveedor->numero }}">
            </div>
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" class="form-control" id="stock" name="stock" value="{{ $proveedor->stock_proveedor }}">
            </div>
