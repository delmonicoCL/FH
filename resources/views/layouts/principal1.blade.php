                                ...
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ url("usuarios")}}">RIDERS</a>
...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
  <symbol id="bootstrap" viewBox="0 0 118 94">
    <title>Administracion FoodHero</title>
...
<main class="d-flex flex-nowrap">
  <h1 class="visually-hidden">FoodHero Administracion</h1>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    ...
    <div class="dropdown">
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="{{ asset('img/superhero.png') }}" alt="" width="32" height="32" class="rounded-circle me-2">
