                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12 col-md-12 mt-3" style="display:flex; align-items: center; justify-content: center;">
                                <a href="{{route('usuarios.create', ['tipo' =>'proveedor'])}}" class="btn col-12" style="background-color: #018780;">
                                    <div class="row">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12 col-md-12 mt-3" style="display:flex; align-items: center; justify-content: center;">
                                <a href="{{route('usuarios.create', ['tipo' =>'rider'])}}" class="btn col-12" style="background-color: #F47D20;">
                                    <div class="row">
                                        <div class="col-sm-4" style="display:flex; align-items: center; justify-content: center;">
